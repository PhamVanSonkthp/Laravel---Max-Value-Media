...
//        'user_types-delete' => 'user_types_delete',
        ...
        'f_a_q_s-list' => 'f_a_q_s_list',
        'f_a_q_s-add' => 'f_a_q_s_add',
        'f_a_q_s-edit' => 'f_a_q_s_edit',
        'f_a_q_s-delete' => 'f_a_q_s_delete',
...
//
//        'post_comments-list' => 'post_comments_list',
//        'post_comments-add' => 'post_comments_add',
//        'post_comments-edit' => 'post_comments_edit',
//        'post_comments-delete' => 'post_comments_delete',
//        'reason_cancels-list' => 'reason_cancels_list', 'reason_cancels-add' => 'reason_cancels_add', 'reason_cancels-edit' => 'reason_cancels_edit', 'reason_cancels-delete' => 'reason_cancels_delete',
//        'app_versions-list' => 'app_versions_list', 'app_versions-add' => 'app_versions_add', 'app_versions-edit' => 'app_versions_edit', 'app_versions-delete' => 'app_versions_delete',
//        'user_withdraws-list' => 'user_withdraws_list', 'user_withdraws-add' => 'user_withdraws_add', 'user_withdraws-edit' => 'user_withdraws_edit', 'user_withdraws-delete' => 'user_withdraws_delete',
        'websites-list' => 'websites_list', 'websites-add' => 'websites_add', 'websites-edit' => 'websites_edit', 'websites-delete' => 'websites_delete',

        'reports-list' => 'reports_list',
        'reports-add' => 'reports_add',
        'reports-edit' => 'reports_edit',
        'reports-delete' => 'reports_delete',
        'reports-list-id' => 'reports_list_id',
        'reports-list-website_id' => 'reports_list_website_id',
        'reports-list-user_id' => 'reports_list_user_id',
        'reports-list-zone_website_id' => 'reports_list_zone_website_id',
        'reports-list-demand_id' => 'reports_list_demand_id',
        'reports-list-date' => 'reports_list_date',
        'reports-list-d_request' => 'reports_list_d_request',
        'reports-list-d_requests_empty' => 'reports_list_d_requests_empty',
        'reports-list-d_impression' => 'reports_list_d_impression',
        'reports-list-d_impressions_unique' => 'reports_list_d_impressions_unique',
        'reports-list-d_ecpm' => 'reports_list_d_ecpm',
        'reports-list-d_revenue' => 'reports_list_d_revenue',
        'reports-list-count' => 'reports_list_count',
        'reports-list-share' => 'reports_list_share',
        'reports-list-p_impression' => 'reports_list_p_impression',
        'reports-list-trafq' => 'reports_list_trafq',
        'reports-list-p_ecpm' => 'reports_list_p_ecpm',
        'reports-list-p_revenue' => 'reports_list_p_revenue',
        'reports-list-profit' => 'reports_list_profit',
        'reports-list-sale_percent' => 'reports_list_sale_percent',
        'reports-list-system_percent' => 'reports_list_system_percent',
        'reports-list-tax' => 'reports_list_tax',
        'reports-list-fix_cost' => 'reports_list_fix_cost',
...
//        'Quản lý Loại khách hàng',
        'Manage f_a_q_s',
//        'Manage posts',
//        'Manage post_comments',
//        'Manage reason_cancels',
//        'Manage app_versions',
//        'Manage user_withdraws',
        'Manage websites',
        'Manage reports',/*step_3*/
    ],
