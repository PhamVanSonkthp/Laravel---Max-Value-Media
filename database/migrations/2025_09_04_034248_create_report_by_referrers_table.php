...
class CreateReportByReferrersTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('report_by_referrers', function (Blueprint $table) {
            $table->id();
            $table->bigInteger('report_id')->index();
            $table->bigInteger('referrer_id')->index();
    ...
    {
        Schema::dropIfExists('report_by_referrers');
    }
}
