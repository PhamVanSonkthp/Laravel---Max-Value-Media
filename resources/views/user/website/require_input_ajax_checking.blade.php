...
<div>
    ...
    <div class="input-wrapper">
        <input type="text" id="require_input_ajax_checking_input" placeholder="example.com" class="red">
...
<script>
    document.addEventListener("DOMContentLoaded", () => {
        ...
        const input = document.getElementById("require_input_ajax_checking_input");
                        ...
                        (response) => {
                            if (response.data.url == value) {
                                ...
                                if (response.code == 200) {
                                    ...
                                    title.classList.add("show");
                                    $("#button_create_website").prop("disabled", false);
                                } else {
