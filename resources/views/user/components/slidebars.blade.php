            ...
            <div class="col-12">
                <div class="menu">
                    <ul class="list">
                        ...
                        <li class="{{request()->routeIs('user.report') ? 'active ' : ''}}open"> <a href="{{route('user.report', ['from' => \Carbon\Carbon::today()->subWeek()->toDateString(), 'to' => \Carbon\Carbon::today()->toDateString()])}}"><span>Report</span></a></li>
