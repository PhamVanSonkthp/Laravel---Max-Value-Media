<nav class="sidebar">
    ...
    <div id="container_slidebar" class="sidebar-body ps">
        <ul class="nav">
            ...
            <li class="nav-item">
                <a href="{{route('user.website')}}" class="nav-link">
                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none"
                         stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"
                         class="feather feather-box link-icon">
                        <path
                    ...
                    <span class="link-title">Sites & Zones</span>
                </a>
            </li>
            ...
            @if(session()->has('impersonate'))
                ...
                <li class="nav-item">
                    <a href="{{ route('administrator.impersonate.leave') }}" class="nav-link">
                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none"
                             stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"
                             class="feather feather-box link-icon">
                            <path
                        ...
                        <span class="link-title">Back to Admin</span>
                    </a>
                </li>
