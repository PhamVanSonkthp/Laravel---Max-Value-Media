<div class="row">
    <div class="col-md-12">
        <div>
            ...
            @include('administrator.components.require_input_text_email', ['label'=>'Email','name' => 'email', 'id' => "modal_create_input_email", 'value' => ''])

            @include('administrator.components.require_input_text', ['label'=>'Password','name' => 'password', 'id' => "modal_create_input_password", 'value' => ''])
