                                                ...
                                                <div class="group blue">
                                                    ...
                                                    @foreach ($groupZoneDimension->zoneDimensions as $zoneDimension)
                                                        ...
                                                        <label class="checkbox-item">
                                                            ...
                                                            <input class="panel_zone_input_number_dimension" type="number" min="1" value="1" max="10" maxlength="2"/>
                                                        </label>
                                                ...
                                                <div class="group blue">
                                                    ...
                                                    @foreach ($groupZoneDimension->zoneDimensions as $zoneDimension)
                                                        <label class="checkbox-item">
                                                            ...
                                                            <input class="panel_zone_input_number_dimension" type="number" min="1" max="10" maxlength="2"
                                                                   value="1"/>
                                                        </label>
                                                    @endforeach
                                                </div>
